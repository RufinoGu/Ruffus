...
void main(void) {
    ...
    (*(volatile __near unsigned char*)0xF92) = 0b00111111;
    (*(volatile __near unsigned char*)0xF93) = 0b11111100;
    (*(volatile __near unsigned char*)0xF94) = 0b10000000;
    (*(volatile __near unsigned char*)0xF95) = 0;
    (*(volatile __near unsigned char*)0xF96) = 0b00000111;

    (((*(volatile __near unsigned char*)0xF82)) &= ~(1<<0));
    (((*(volatile __near unsigned char*)0xF82)) &= ~(1<<1));
    (((*(volatile __near unsigned char*)0xF82)) &= ~(1<<2));
    (((*(volatile __near unsigned char*)0xF83)) &= ~(1<<4));
    (((*(volatile __near unsigned char*)0xF83)) &= ~(1<<5));
    (((*(volatile __near unsigned char*)0xF83)) &= ~(1<<6));
    (((*(volatile __near unsigned char*)0xF83)) &= ~(1<<7));
